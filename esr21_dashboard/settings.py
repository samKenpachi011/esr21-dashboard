"""
Django settings for esr21_dashboard project.
...
SECRET_KEY = 'n75_l#oc9b=$g)y$5u#3!0fm^^trn@h6d=&bhk*4l^(n4_vvy)'
...
ROOT_URLCONF = 'esr21_dashboard.urls'
...
WSGI_APPLICATION = 'esr21_dashboard.wsgi.application'
